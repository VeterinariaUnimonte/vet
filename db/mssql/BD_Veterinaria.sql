...
CREATE TABLE tab_cliente (
  ...
  [CADASTRO] datetime2(0) NOT NULL DEFAULT GETDATE()
) ;
...
--
ALTER TABLE [tab_agendamento]
  MODIFY [COD_AGENDAMENTO] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tab_cliente`
--
ALTER TABLE [tab_cliente]
  MODIFY [COD_CLIENTE] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tab_disponibilidade`
--
ALTER TABLE [tab_disponibilidade]
  MODIFY [COD_DISPONIBILIDADE] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tab_especialidade`
--
ALTER TABLE [tab_especialidade]
  MODIFY [COD_ESPECIALIDADE] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tab_funcionario`
--
ALTER TABLE [tab_funcionario]
  MODIFY [COD_FUNCIONARIO] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tab_pet`
--
ALTER TABLE [tab_pet]
  MODIFY [COD_PET] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `tab_procedimento`
--
ALTER TABLE [tab_procedimento]
  MODIFY [COD_PROCEDIMENTO] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tab_tipo_procedimento`
--
ALTER TABLE [tab_tipo_procedimento]
  MODIFY [COD_TIPO_PROCEDIMENTO] cast(13 as int) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
